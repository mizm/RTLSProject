...
namespace clientTest2
{
	...
	public partial class LoginForm : Form
	{
		...
		//public string iptostring = "192.168.0.11";
		//165.229.125.117string iptostring = "165.229.125.50";
		string iptostring = "165.229.125.117";
		public LoginForm()
		{
		...
		private void LoginBtn_Click(object sender, EventArgs e)
		{
			...
			clientSocket.Connect(iptostring, 9999);
			stream = clientSocket.GetStream();
